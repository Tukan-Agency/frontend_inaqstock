    ...
    const fetchMarketData = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://api.polygon.io/v2/aggs/ticker/${symbol}/range/1/day/${formattedSevenDaysAgo}/${formattedToday}?adjusted=true&sort=asc&apiKey=MF98h8vorj239xqQzHGEgjZ4JefrmFOj`
        );
