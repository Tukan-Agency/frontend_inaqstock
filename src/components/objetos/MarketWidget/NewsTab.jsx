...
export default function NewsPanel({ symbol }) {
  ...
  return (
    <div className="max-h-[300px] overflow-y-auto">
      {news.length > 0 ? (
        news.map((item, index) => (
          <div key={item.id || index} className="border-b border-gray-200 last:border-none">
            <div 
              className={`px-4 py-3 cursor-pointer transition-colors ${
                expandedNews === (item.id || index) ? "bg-blue-50" : "hover:bg-gray-50"
              }`}
...
const mockNewsData = [
  {
    ...
    description: "La principal criptomoneda ha alcanzado un nuevo máximo desde noviembre de 2021, impulsada por la aprobación de los ETFs de Bitcoin y el interés institucional.",
  ...
  },
  {
    ...
    description: "La Reserva Federal de EE.UU. ha decidido mantener las tasas de interés sin cambios en su reunión de septiembre, pero ha señalado la posibilidad de recortes en los próximos meses.",
  ...
  },
  {
    ...
    description: "La red Ethereum ha completado con éxito su última actualización importante, que promete reducir los costos de gas y mejorar la escalabilidad de la red.",
